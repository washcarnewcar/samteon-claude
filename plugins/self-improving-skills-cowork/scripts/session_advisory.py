#!/usr/bin/env python3
"""UserPromptSubmit-hook logic for the self-improving-skills-cowork plugin.
...
def main():
    ...
    lines = [
        "[self-improving-skills-cowork] 자기개선 루프 활성. 복잡한 작업·까다로운 디버깅·"
        "새 기법 발견을 끝냈고 재사용 가능하다면, /distill-skill 을 실행하거나 Task(또는 "
        "Agent) 도구로 subagent_type=\"self-improving-skills-cowork:skill-distiller\""
